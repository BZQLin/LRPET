...
def main_worker(gpu, args):
    ...
    base_model = torch.load('LRPET/CNN/imagenet/save/pth_epo84_prun0.7_num20_resnet50_copy.pth')['state_dict']
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch == 119:
            ...
            # print('==> best')
            # model_test = copy.deepcopy(model)
            # base_model = torch.load('%s/pth_epo%d_prun%s_num%d_%s.pth'%(args.s, epoch, args.prune_ratio, args.num, args.model_name))['state_dict']
            # model_test.load_state_dict(base_model)
            # print('==> exchange to SVD')
